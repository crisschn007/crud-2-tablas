...
<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    ...
    <a href="insertarTipoProducto.php" class="btn btn-info">Agregar Nuevo Tipo de Producto</a>  
...
<table class="table table-striped-columns table-info">
  ...
  <tbody>
    <tr>
      ...
      <td>
        <a href="editartipoProducto.php?id=<?php echo $row['id'] ?>" class="link-dark"><i class="fa-solid fa-pencil"></i></a>
        <a href="eliminartipoProducto.php?id=<?php echo $row['id']?>" class="link-danger"><i class="fa-solid fa-trash-can"></i></a>
    </td>
    </tr>
    <?php } ?>
